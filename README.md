...
#### Baltagi/Li (1991) in pbsystest(): fixed degrees of freedom; added check for correct input

#### Baltagi/Li (1995): implemented statistic and test for LM5 (LM test for first-order serial correlation in a fixed effects model)
